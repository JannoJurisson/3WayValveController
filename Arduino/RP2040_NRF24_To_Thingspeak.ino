...
/* Wi-Fi info */
char ssid[] = "Telia-7DCD82";  // your network SSID (name)
char pass[] = "PipijaFelix";   // your network password
WiFiMulti multi;
...
String apiKey = "5063D0Z14L0G4Q9U";    // apki key

unsigned long myChannelNumber = 377529;
const char* myWriteAPIKey = "5063D0Z14L0G4Q9U";
